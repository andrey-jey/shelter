const pets = [
  ...
  function cardCreator (array, id ){
    
      array.map(item => {let div = document.createElement('div');
      ...
      p.innerHTML = item.name;
        ...
        p.className = "names"
        // const kek = document.querySelector(".pets_cards");
        
        imageParent.appendChild(div);
        
})
}
 cardCreator(pets,"firstCont")
 cardCreator(pets2,"secondCont")
